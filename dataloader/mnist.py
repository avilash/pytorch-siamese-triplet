...
class MNIST_DS(object):
    ...
    def __init__(self, train_dataset, test_dataset):
    	self.__train_data = train_dataset.train_data
        self.__test_data = test_dataset.test_data
        self.__train_labels = train_dataset.train_labels
        self.__test_labels = test_dataset.test_labels
